  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full max-w-7xl items-start">
        ...
        <div className="space-y-6">
          <div className="text-left">
            <h1 className="text-4xl font-bold text-black mb-2">
              MY PROGRAM<span className="text-[#67c2d5]">...</span>
            </h1>
            ...
            <button className="bg-[#67c2d5] text-white font-semibold px-6 py-2 rounded hover:bg-red-600">
              JOIN NOW
            </button>
          </div>
          ...
          />
          <Card
            icon={<FaDumbbell className="h-10 w-10 text-white" />}
            title="Abdominal abs"
        ...
        <div className="space-y-6">
          <Card
            icon={<FaUserAlt className="h-10 w-10 text-white" />}
            title="Shoulders"
...
const Card = ({ icon, title, desc }) => (
  <div className="bg-[#67c2d5] p-6 rounded-lg shadow hover:shadow-md transition text-center">
